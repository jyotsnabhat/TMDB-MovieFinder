        ...
        return (
            <>
                    ...
                    <div className="row">
                        <div className="bg-image w-100">
                            <Link to="/" className="mb-5">
                                <i className="fa fa-arrow-left text-white arrow-position"></i>
                            </Link>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-6">
                            <img src={"https://image.tmdb.org/t/p/w185" + movie.movie.poster_path} className="poster img-responsive poster-w shadow-lg"/>
                        </div>
                        <div className="col-6">
